        ...
        <section id="about" className="py-24 px-4 bg-gray-900 text-white">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-xl md:text-2xl text-gray-400 leading-relaxed mb-12 font-light">
                    {module?.name || 'MacroHR'} was built to eliminate the tedious back-and-forth between inspecting elements and writing code.
                ...
                <div className="flex items-center justify-center gap-4">
                    ...
                    <div className="text-left">
                        <p className="font-bold text-white">Built by {module?.creator || 'Web4strategy'}</p>
